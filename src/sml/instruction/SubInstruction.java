...
/**
 * Performs a subtraction operation on two registers.
 * The integer value of the second (source) register is subtracted from the first (result).
...
public class SubInstruction extends Instruction {
    ...
    /**
     * Constructor: specifies the label (if it exists) and which registers to subtract
     *
     * @param label  optional label (can be null)
     * @param result the register to which result of the operation is stored
     * @param source the register from which the value to subtract is used
     */
